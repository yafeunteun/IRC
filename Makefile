...
# Generated by qmake (3.0) (Qt 5.0.1) on: jeu. oct. 10 14:29:21 2013
# Project:  irc_server.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile irc_server.pro
#############################################################################
...
Makefile: irc_server.pro /usr/share/qt5/mkspecs/linux-g++-64/qmake.conf /usr/share/qt5/mkspecs/features/spec_pre.prf \
		/usr/share/qt5/mkspecs/common/shell-unix.conf \
		/usr/share/qt5/mkspecs/common/unix.conf \
		/usr/share/qt5/mkspecs/common/linux.conf \
		/usr/share/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	@test -d .tmp/irc_server1.0.0 || $(MKDIR) .tmp/irc_server1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/irc_server1.0.0/ && $(COPY_FILE) --parents server.h client.h channel.h .tmp/irc_server1.0.0/ && $(COPY_FILE) --parents main.cpp server.cpp client.cpp channel.cpp .tmp/irc_server1.0.0/ && (cd `dirname .tmp/irc_server1.0.0` && $(TAR) irc_server1.0.0.tar irc_server1.0.0 && $(COMPRESS) irc_server1.0.0.tar) && $(MOVE) `dirname .tmp/irc_server1.0.0`/irc_server1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/irc_server1.0.0
